...
func SignUp(c echo.Context) error {
	...
	new_medico := models.NewMedico(shortuuid.New(), input_medico.IdEstablecimiento, input_medico.Nombre, input_medico.Apellido, input_medico.Colegiatura, input_medico.DocumentoIdentidad, input_medico.Correo, encrypted_pass, input_medico.Direccion)
